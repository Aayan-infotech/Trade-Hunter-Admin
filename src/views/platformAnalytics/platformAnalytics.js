...
const AnalyticsReports = () => {
  ...
  useEffect(() => {
    axios
      .get(`https://api.tradehunters.com.au/api/Prvdr/getAll?search=${providerSearch}`, commonConfig)
      .then((res) => {
  ...
  useEffect(() => {
    axios
      .get("https://api.tradehunters.com.au/api/count/activeUsers", commonConfig)
      .then((res) => {
    ...
    axios
      .get("https://api.tradehunters.com.au/api/auth/recentSignups", commonConfig)
      .then((res) => {
    ...
    axios
      .get("https://api.tradehunters.com.au/api/SubscriptionNew/retentionRate", commonConfig)
      .then((res) => {
    ...
    axios
      .get("https://api.tradehunters.com.au/api/jobPost/getJobTrends", commonConfig)
      .then((res) => {
        setJobTrends({
    ...
    axios
      .get("https://api.tradehunters.com.au/api/jobPost/getTopBusinessCount", commonConfig)
      .then((res) => {
        if (res.data.data && Array.isArray(res.data.data)) {
    ...
    axios
      .get("https://api.tradehunters.com.au/api/jobpost/topLocation", commonConfig)
      .then((res) => {
        if (res.data.data && Array.isArray(res.data.data)) {
  ...
  const handleProviderClick = (provider) => {
    ...
    axios
      .get(`https://api.tradehunters.com.au/api/provider/completionRate/${providerId}`, commonConfig)
      .then((res) => {
    ...
    axios
      .get(`https://api.tradehunters.com.au/api/rating/getAvgRating/${providerId}`, commonConfig)
      .then((res) => {
