...
const SubscriptionManagement = () => {
  ...
  const fetchSubscriptions = async () => {
    ...
    try {
      const res = await axios.get(
        'https://api.tradehunters.com.au/api/SubscriptionNew/subscription-plans',
        commonConfig,
      )
  ...
  const fetchSubscriptionTypes = async () => {
    try {
      const res = await axios.get(
        'https://api.tradehunters.com.au/api/SubscriptionNew/subscription-type',
        commonConfig,
      )
  ...
  const handleAddSubscription = async () => {
    ...
    try {
      await axios.post(
        'https://api.tradehunters.com.au/api/SubscriptionNew/subscription-plan',
        payload,
        commonConfig,
      )
      fetchSubscriptions()
  ...
  const handleSaveEditSubscription = async () => {
    ...
    try {
      await axios.put(
        `https://api.tradehunters.com.au/api/SubscriptionNew/subscription-plan/${editSubscription._id}`,
        payload,
        commonConfig,
      )
      fetchSubscriptions()
  ...
  const handleDeleteSubscription = async (id) => {
    if (window.confirm('Delete Subscription?')) {
      try {
        await axios.delete(
          `https://api.tradehunters.com.au/api/SubscriptionNew/subscription-plan/${id}`,
          commonConfig,
        )
        fetchSubscriptions()
      } catch (e) {
  ...
  const handleDeleteSubscriptionType = async (id) => {
    if (window.confirm('Are you sure you want to delete this subscription type?')) {
      try {
        await axios.delete(
          `https://api.tradehunters.com.au/api/SubscriptionNew/subscription-type/${id}`,
          commonConfig,
        )
        fetchSubscriptionTypes()
      } catch (e) {
